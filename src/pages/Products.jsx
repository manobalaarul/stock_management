        ...
        <table className="w-full border border-gray-300 mt-2 text-left bg-white">
          <thead>
            <tr className=" border-b">
              ...
              <th className="p-3 border-r">Actual Price</th>
              <th className="p-3 border-r text-xs">Selling Price</th>
              ...
              <tr key={row._id} className="border-b hover:bg-gray-100">
                ...
                <td className="p-3 border-r">
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={() => {
                        setSelectedDeleteId(row._id); // save the id
                        setOpenConfirmDeleteBox(true); // open confirm box
                      }}
                      className="border border-red-400 px-2 py-2 rounded"
                    >
                      <MdDelete />
                    </button>
                  </div>
                ...
                <td className="p-3 border-r">
                  <img src={PathToUrl(row.image[0])} alt="" className="w-24" />
                </td>
                <td className="p-3 border-r">
                ...
                <td className="p-3 border-r">{row.actual_price}</td>
                <td className="p-3 border-r">{row.selling_price}</td>
        ...
        <ConfirmBox
          ...
          confirm={() => {
            if (selectedDeleteId) {
              ...
              setOpenConfirmDeleteBox(false); // close box after delete
              setSelectedDeleteId(null); // reset
            }
          }}
